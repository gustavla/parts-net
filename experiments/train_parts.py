...
if __name__ == '__main__':
    ...
    data = dd.io.load(data_path('train'), '/data').astype(np.float64)
    #data = data[..., np.newaxis].astype(np.float64)
        ...
        if 0:
            ...
            layers += [
                ...
                pnet.OrientedPartsLayer(40, 32, (6, 6), settings=dict(outer_frame=1, 
                                                          ...
                                                          min_prob=0.0005,
                                                          #bedges=dict( k=5, minimum_contrast=0.05, spread='orthogonal', radius=1, #pre_blurring=1, contrast_insensitive=False,),
                                                          )),
